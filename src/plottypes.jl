...
function build_transport_plot_data(
    ...
    md = result.metadata
    fermi_Ha = haskey(md, "fermi_dft_Ha") ? md["fermi_dft_Ha"] :
    ...
    if abscissa == "mu"
        ...
        isnothing(iT) && throw(ArgumentError(
