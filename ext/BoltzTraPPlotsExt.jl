...
# Part of BoltzTraP.jl - Plots.jl extension
#
# Implementations moved from src/plotting.jl

module BoltzTraPPlotsExt

using Brillouin
using Plots
import BoltzTraP
using BoltzTraP: InterpolationResult, TransportResult, BandPlotData, TransportPlotData
using BoltzTraP: plot_bands, plot_transport
using BoltzTraP: load_interpolation, load_integrate
using BoltzTraP: getBands, BOHR_TO_ANG, HA_TO_EV
...
function BoltzTraP.plot_transport(
    ...
    return BoltzTraP.plot_transport(
        result;
        quantity = quantity,
        component = component,
        abscissa = abscissa,
