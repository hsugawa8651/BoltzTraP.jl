...
**BoltzTraP.jl:**
> Sugawara, H. (2026). BoltzTraP.jl: Julia port of BoltzTraP2 for band structure interpolation and transport coefficient calculation (Version 0.4.2) [Computer software]. [doi:10.5281/zenodo.22121103](https://doi.org/10.5281/zenodo.22121103)
