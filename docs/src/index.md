...
**BoltzTraP.jl:**
> Sugawara, H. (2026). BoltzTraP.jl: Julia port of BoltzTraP2 for band structure interpolation and transport coefficient calculation (Version 0.3.0) [Computer software]. [doi:10.5281/zenodo.18605978](https://doi.org/10.5281/zenodo.18605978)
