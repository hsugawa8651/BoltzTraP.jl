...
|--------|-------------|--------|
| [VASP](@ref) | `vasprun.xml` | [`load_vasp`](@ref) |
| [Quantum ESPRESSO](@ref) | `data-file-schema.xml` | [`load_qe`](@ref) |
| [Wien2k](@ref) | `case.struct`, `case.energy` | [`load_wien2k`](@ref) |
| [GENE/Generic](@ref) | `case.structure`, `case.energy` | [`load_gene`](@ref) |
| [ABINIT](@ref) | `*_GSR.nc` (NetCDF) | [`load_abinit`](@ref) |
| [DFTK.jl](@ref) | `scfres` from DFTK.jl | [`load_dftk`](@ref) |
